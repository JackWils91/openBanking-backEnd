...
-- DROP DATABASE IF EXISTS jackwilson;
DROP DATABASE IF EXISTS open_banking_test;
CREATE DATABASE open_banking_test;

-- connect database - this is actually connected through the pgPool
